...
homepage_ui <- function(id) {
  ...
  tabPanel(
    ...
    tags$footer(style="text-align:center; margin-top: 20px;",
                "Prof. Xuebin Zhang's Lab, State Key Laboratory of Crop Stress Adaptation and Improvement, Henan Joint International Laboratory for Crop Multi-Omics Research, School of Life Sciences, Henan University, Kaifeng 475004, China")
  )
}
